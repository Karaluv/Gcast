...
class Menu:
    ...
    def draw_all(self):
        for button in self.buttons:
            ...
            pygame.draw.line(self.surface, (255, 255, 0), (button.x, button.y + button.h - 1),
                             (button.x + button.w, button.y + button.h - 1), 3)
            pygame.draw.arc(self.surface, (255, 255, 0), (button.x - button.h / 2, button.y, button.h, button.h),
                            math.pi / 2, math.pi * 1.5, 3)
            pygame.draw.arc(self.surface, (255, 255, 0),
                            (button.x + button.w - button.h / 2, button.y, button.h, button.h), 3 * math.pi / 2,
                            math.pi / 2, 3)
            ...
            if button.presence == 1:
                ...
                pygame.draw.line(self.surface, (255, 255, 0), (button.x, button.y + button.h - 1),
                                 (button.x + button.w, button.y + button.h - 1), 5)
                pygame.draw.arc(self.surface, (255, 255, 0), (button.x - button.h / 2, button.y, button.h, button.h),
